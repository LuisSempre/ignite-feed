  ...
  return (
    <div className=" bg-gray-900 rounded-md h-screen space-y-4 p-8 border border-green-500">
      ...
      <form className="flex flex-col justify-start items-start space-y-4">
        ...
        <textarea className="w-full rounded-md bg-black placeholder-green-500 p-4 resize-none focus:-green-500" placeholder="Comente aqui" />
        <button
        type="submit"
        className="border border-green-500 rounded-full px-4 py-2 text-green-500 hidden "
        >Publicar</button>
      </form>
    </div>
  );
